...
export default function LoginAdminPage() {
  ...
  function signIn() {
    ...
    onLogin(user)
      .then((user) => {
        // window.localStorage.setItem('access_tkn_lflw',user.access_token);
        // window.localStorage.setItem('refresh_tkn_lflw',user.refresh_token);
        // cookies.set('access_tkn_lflw',user.access_token);
        // cookies.set('refresh_tkn_lflw',user.refresh_token);        
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center bg-muted">
      <div className="flex w-72 flex-col items-center justify-center gap-2">
        ...
        <span className="mb-6 text-2xl font-semibold text-primary">Login Admin</span>
        <Input
